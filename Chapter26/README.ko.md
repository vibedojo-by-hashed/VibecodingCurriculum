...
[Chapter 25: MCP 연동](../Chapter25/README.ko.md)에서 MCP를 통해 Claude가 외부 서비스와 대화하는 방법을 배웠습니다. 데이터베이스 조회, GitHub 이슈 관리, Slack 알림 등을 직접 실행할 수 있게 되었죠.
...
[Chapter 27: 팀 협업](../Chapter27/README.ko.md)으로 넘어가시기 바랍니다.
