...
[Chapter 23: Hooks & Commands](../Chapter23/README.ko.md)에서 Hooks와 Commands로 자동화의 기초를 배웠습니다. 이번 챕터에서는 한 단계 더 나아가 Claude에게 **전문가 역할**을 부여하고, **키워드 기반 자동화**를 구현하는 방법을 배웁니다.
...
[Chapter 25: MCP 연동](../Chapter25/README.ko.md)으로 넘어가시기 바랍니다.
