...
[Chapter 22: 설정 심화](../Chapter22/README.ko.md)에서 CLAUDE.md와 settings.json으로 Claude의 기본 동작을 설정하는 방법을 배웠습니다. 이번 챕터에서는 한 단계 더 나아가 **자동화**의 세계로 들어갑니다.
...
[Chapter 24: Agents & Skills](../Chapter24/README.ko.md)로 넘어가시기 바랍니다.
